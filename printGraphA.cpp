// Zacharea Kaawan (251008043), printGraphA implementation file, 2020-10-06
...
// PrintGraphAscending, Prints graph in ascending order based off of user chosen parameter,
...
void printGraphAscending(int srtBy, vector<DataRecord> vect){
   int highest;
   int numbPerSymbol;
   
    if (srtBy == 1){
        highest = vect.at(9).getNewConfCases();
        if (highest >= 70){
        ...
        highest = vect.at(9).getNewDeaths();
        if (highest >= 70){
            numbPerSymbol = highest/70;
        }
        else if (highest == 0)
        ...
        highest = vect.at(9).getNewRecovCases();
        if (highest >= 70){
            numbPerSymbol = highest/70;
        }
        else if (highest == 0)
        ...
        highest = vect.at(9).getTotalConfCases();
        if (highest >= 70){
            numbPerSymbol = highest/70;
        }
        else if (highest == 0)
    ...
    {
        highest = vect.at(9).getTotalDeaths();
        if (highest >= 70){
            numbPerSymbol = highest/70;
        }
        else if (highest == 0)
    ...
    {
        highest = vect.at(9).getTotalRecovCases();
        if (highest >= 70){
            numbPerSymbol = highest/70;
        }
        else if (highest == 0)
